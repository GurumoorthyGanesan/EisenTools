...
namespace EisentTools.UI
{
    public class GridStrip : ToolStrip
    {
        ...
        public bool IsValidDragSource(ToolStripButton b)
        {
            TableLayoutPanelCellPosition sourcePos =
        ...
        public static bool IsValidDragSource(
            TableLayoutPanelCellPosition sourcePos,
            TableLayoutPanelCellPosition emptyPos)
        {
    ...
    class ToolStripRendererDemo : Form
    {
        public ToolStripRendererDemo()
        {
            this.Controls.Add(new GridStrip());
        }
    }
}
